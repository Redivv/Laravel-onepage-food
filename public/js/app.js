...
/* harmony import */ var _page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./page */ "./resources/js/page.js");
/* harmony import */ var _page__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_page__WEBPACK_IMPORTED_MODULE_0__);
...
function main() {
  ...
  $('.productsAllBtn').on('click', function () {
    ...
    $('div.productsIco').each(function () {
      ...
      var selectedItem_class = selectedItem.replace(/\s+/g, '-').toLowerCase();
      html += '<div class="' + selectedItem_class + ' col-md-3 contactSelectedItem selectedItem">' + selectedIcon + '<div class="contactSelectedItemDesc">' + selectedItem + '</div>' + '</div>';
...
__webpack_require__(/*! C:\xampp\htdocs\Projects\HaHaHACCP\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\xampp\htdocs\Projects\HaHaHACCP\resources\sass\app.scss */"./resources/sass/app.scss");
